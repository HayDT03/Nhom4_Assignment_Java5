  ...
  <main>
    <div class="container-fluid">
      ...
      <nav aria-label="Page navigation example" style="margin-left: 780px;">
        <ul class="pagination ">
          <li class="page-item">
            <a class="page-link " href="/allproduct?p=0" aria-label="Previous">
              <span aria-hidden="true">&laquo;</span>
            </a>
          </li>
       
          <li class="page-item"><a class="page-link" href="/allproduct?p=${page.number-1}"><</a></li>
          
          <li class="page-item"><a class="page-link" href="/allproduct?p=${page.number+1}">></a></li>
          <li class="page-item">
            <a class="page-link" href="/allproduct?p=${page.totalPages-1}" aria-label="Next">
