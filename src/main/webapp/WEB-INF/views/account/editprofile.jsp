                ...
                <div class="col-12 col-md-8 col-lg-6">
                    ...
                    <div class="card bg-white shadow-lg">
                        <div class="card-body p-5">
                            <form:form class="mb-3 mt-md-4" modelAttribute="user" method="post" action="/account/editprofile">
                                <h2 class="fw-bold mb-2 text-uppercase text-center">Thay đổi thông tin</h2>
                                ...
                                <div class="mb-3">
                                    ...
                                    <form:input type="text" path="id" class="form-control" placeholder="name12" readonly="true"></form:input>
