...
<div class="row justify-content-center">
	<form class="form col-md-7 p-5" style="border: 1px solid black;">
		<div class="form-group">
			<label>Họ tên người dùng:</label> <input type="text"
				class="form-control">
		</div>
		<div class="form-group">
			<label>Tài khoản</label> <input type="text" class="form-control">
		</div>
		<div class="form-group">
			<label>Ngày sinh</label> <input type="date" class="form-control">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="row">
				<div class="form-check ml-4">
					<input class="form-check-input" type="radio" value="option1"
						name="exampleRadios1"> <label class="form-check-label">
						Quản trị </label>
				</div>
		...
		<div class="form-group">
			<label>Địa chỉ</label> <input type="text" class="form-control">
		</div>
		...
		<tbody class="bg-light">
			<c:forEach var="list" items="${list}">
				<tr>
					...
					<td>${list.active ? 'Đang hoạt động' : 'Khoá'}</td>
